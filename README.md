# Pearmo
This is a chat and conferencing website communicating via WebRTC and using Firebase for signaling. It's built using [Victor Hugo](https://github.com/netlify-templates/victor-hugo).
